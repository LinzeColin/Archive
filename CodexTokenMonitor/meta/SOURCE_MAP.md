...
## Archived System Name

Codex Token Monitor

## GitHub Target

`LinzeColin/Archive/CodexTokenMonitor`
...
- Dashboard: `python3 -m codex_usage_monitor.cli dashboard --port 8766`
- Menu app: `/Applications/SwiftBar.app/Contents/MacOS/SwiftBar`

These were stopped only after the GitHub backup and verification completed.
